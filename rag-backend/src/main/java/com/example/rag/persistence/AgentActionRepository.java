...
public class AgentActionRepository {
    ...
    public boolean claimForExecution(String runCode, String actionCode, String operator, OffsetDateTime now) {
        return mapper.claimForExecution(runCode, actionCode, operator, now) == 1;
    }
